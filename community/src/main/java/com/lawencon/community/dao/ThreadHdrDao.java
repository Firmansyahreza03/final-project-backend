...
public class ThreadHdrDao extends AbstractJpaDao<ThreadHdr> {
	...
	public List<ThreadHdr> findByThreadName(String name) throws Exception{
		StringBuilder sql = new StringBuilder()
				.append(" SELECT th.thread_name, th.is_premium, th.industry_id, ti.industry_name, th.category_id, tc.category_name, th.created_by ")
				...
				.append(" WHERE LOWER(th.thread_name) = LOWER(:name) ");
